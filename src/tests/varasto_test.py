...
class TestVarasto(unittest.TestCase):
    ...
    def test_negatiiviset_alkuarvot(self):
        uusi_varasto = Varasto(-10, -6)
    ...
    def test_liian_iso_alkusaldo(self):
        uusi_varasto = Varasto(5, 5.2)
        self.assertAlmostEqual(uusi_varasto.saldo, 5)
